...
const DEMO_FIXTURE_EXCLUDE: Partial<Record<DemoSlug, string[]>> = {
  ...
  syntax: ["03.about"],
  herald: ["03.about"],
  // HTML5 UP blogs/landings/galleries with installing-* demo posts
  striped: ["03.about"],
  "future-imperfect": ["03.about"],
  massively: ["03.about"],
  editorial: ["03.about"],
  dopetrope: ["03.about"],
  phantom: ["03.about"],
  "read-only": ["03.about"],
  "strongly-typed": ["03.about"],
  forty: ["03.about"],
  photon: ["03.about"],
  aerial: ["03.about"],
  alpha: ["03.about"],
  arcana: ["03.about"],
  "big-picture": ["03.about"],
  dimension: ["03.about"],
  directive: ["03.about"],
  "escape-velocity": ["03.about"],
  ethereal: ["03.about"],
  eventually: ["03.about"],
  halcyonic: ["03.about"],
  helios: ["03.about"],
  ...
  minimaxing: ["03.about"],
  multiverse: ["03.about"],
  "paradigm-shift": ["03.about"],
  prologue: ["03.about"],
  "solid-state": ["03.about"],
  spectral: ["03.about"],
  stellar: ["03.about"],
  story: ["03.about"],
  telephasic: ["03.about"],
