...
template: post
published: true
summary: What this port preserves from HTML5 UP Parallelism, and what Dune changes.
taxonomy:
  tag: [chrome, parallelism, fidelity]
---

This demo exercises: masonry-style image columns.
...
Compare side-by-side with [https://html5up.net/parallelism](https://html5up.net/parallelism) when QA'ing visual parity.
