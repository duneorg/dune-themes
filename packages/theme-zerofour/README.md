...
**Templates:** `default` · `post` · `blog` · `search` · `error` · `archives` — faithful page-wrapper shell with header nav and banner landing; inner pages use the no-sidebar content column.
