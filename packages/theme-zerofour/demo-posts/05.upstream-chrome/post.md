...
template: post
published: true
summary: What this port preserves from HTML5 UP Zerofour, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/zerofour](https://html5up.net/zerofour) when QA'ing visual parity.
