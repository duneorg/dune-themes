...
template: post
published: true
summary: What this port preserves from HTML5 UP TXT, and what Dune changes.
taxonomy:
  tag: [chrome, txt, fidelity]
---

This demo exercises: compact text-forward layout with sidebar nav.
...
Compare side-by-side with [https://html5up.net/txt](https://html5up.net/txt) when QA'ing visual parity.
