...
template: post
published: true
summary: What this port preserves from HTML5 UP Miniport, and what Dune changes.
taxonomy:
  tag: [chrome, miniport, fidelity]
---

This demo exercises: one-page scrolly sections with article tiles.
...
Compare side-by-side with [https://html5up.net/miniport](https://html5up.net/miniport) when QA'ing visual parity.
