...
Minimal sticky-nav portfolio with icon boxes. Adapted from
[HTML5 UP Miniport](https://html5up.net/miniport) (CC BY 3.0).

![Miniport screenshot](https://themes.getdune.org/miniport/themes/miniport/static/screenshot.png)

**Demo**: https://themes.getdune.org/miniport

**Tags**: dune-theme, portfolio, html5up, gallery
...
themes:
  - name: miniport
    src: jsr:@dune/theme-miniport@1.0.0
...
Sticky top nav, portrait hero, and icon-box explore section. See the
[live demo](https://themes.getdune.org/miniport).

## Templates

| Template | Role |
|---|---|
| `default` | Portrait hero + icon boxes on home; plain pages elsewhere |
| `blog` | Icon-box post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Miniport is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/miniport](https://html5up.net/miniport)).
