...
template: post
published: true
summary: Theme options for the Hyperspace demo — still a single upstream design.
taxonomy:
...
| Option | Notes |
|--------|--------|
| `show_intro` | see `theme.yaml` |
| `intro_title` | see `theme.yaml` |
| `intro_subtitle` | see `theme.yaml` |
| `show_html5up_credit` | see `theme.yaml` |
| `footer_text` | see `theme.yaml` |

**No dark mode / no color-scheme presets.** Upstream Hyperspace is one design;
