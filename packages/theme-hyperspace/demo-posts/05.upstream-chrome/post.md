...
template: post
published: true
summary: What this port preserves from HTML5 UP Hyperspace, and what Dune changes.
taxonomy:
  tag: [chrome, hyperspace, fidelity]
---

This demo exercises: sidebar features + spotlight grid on a dark landing shell (still single upstream design, no Dune scheme switcher).
...
Compare side-by-side with [https://html5up.net/hyperspace](https://html5up.net/hyperspace) when QA'ing visual parity.
