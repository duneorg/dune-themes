...
Persistent sidebar landing with fullscreen intro. Adapted from
[HTML5 UP Hyperspace](https://html5up.net/hyperspace) (CC BY 3.0).

![Hyperspace screenshot](https://themes.getdune.org/hyperspace/themes/hyperspace/static/screenshot.png)

**Demo**: https://themes.getdune.org/hyperspace

**Tags**: dune-theme, landing, html5up, sidebar
...
themes:
  - name: hyperspace
    src: jsr:@dune/theme-hyperspace@1.0.0
...
Persistent sidebar landing with fullscreen intro. See the
[live demo](https://themes.getdune.org/hyperspace).

## Templates

| Template | Role |
|---|---|
| `default` | Sidebar chrome with intro on home; content sections elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Hyperspace is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/hyperspace](https://html5up.net/hyperspace)).
