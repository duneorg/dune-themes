...
Fullscreen thumb-grid gallery landing. Adapted from
[HTML5 UP Multiverse](https://html5up.net/multiverse) (CC BY 3.0).

![Multiverse screenshot](https://themes.getdune.org/multiverse/themes/multiverse/static/screenshot.png)

**Demo**: https://themes.getdune.org/multiverse
...
[live demo](https://themes.getdune.org/multiverse).

## Templates

| Template | Role |
|---|---|
| `default` | Gallery landing on home; plain pages elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Multiverse is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/multiverse](https://html5up.net/multiverse)).
