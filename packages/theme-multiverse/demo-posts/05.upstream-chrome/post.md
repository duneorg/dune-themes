...
template: post
published: true
summary: What this port preserves from HTML5 UP Multiverse, and what Dune changes.
taxonomy:
  tag: [chrome, multiverse, fidelity]
---

This demo exercises: lightbox-style gallery tiles on the home grid.
...
Compare side-by-side with [https://html5up.net/multiverse](https://html5up.net/multiverse) when QA'ing visual parity.
