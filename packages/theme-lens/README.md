...
Fullscreen thumbnail gallery. Adapted from
[HTML5 UP Lens](https://html5up.net/lens) (CC BY 3.0).

![Lens screenshot](https://themes.getdune.org/lens/themes/lens/static/screenshot.png)

**Demo**: https://themes.getdune.org/lens

**Tags**: dune-theme, gallery, portfolio, html5up
...
Staggered preload, icon nav, and thumbnail gallery on home and blog. See
the [live demo](https://themes.getdune.org/lens).

## Templates

| Template | Role |
|---|---|
| `default` | Thumbnail gallery on home; content panel elsewhere |
| `blog` | Thumbnail post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Lens is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/lens](https://html5up.net/lens)).
