...
Full-screen landing with modal article panels. Adapted from
[HTML5 UP Dimension](https://html5up.net/dimension) (CC BY 3.0).

![Dimension screenshot](https://themes.getdune.org/dimension/themes/dimension/static/screenshot.png)

**Demo**: https://themes.getdune.org/dimension

**Tags**: dune-theme, landing, html5up, modal
...
themes:
  - name: dimension
    src: jsr:@dune/theme-dimension@1.0.0
...
Full-screen landing with modal article panels. See the
[live demo](https://themes.getdune.org/dimension).

## Templates

| Template | Role |
|---|---|
| `default` | Landing header on home; modal article panels elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Dimension is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/dimension](https://html5up.net/dimension)).
