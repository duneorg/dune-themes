...
template: post
published: true
summary: What this port preserves from HTML5 UP Telephasic, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/telephasic](https://html5up.net/telephasic) when QA'ing visual parity.
