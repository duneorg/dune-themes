---
title: Massively's typography
date: 2026-02-01
template: post
published: true
summary: How Massively sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, massively]
---

Massively is the HTML5 UP hero blog adapted for Dune. This post dogfoods
...
That horizontal rule is the divider Massively’s stylesheet defines.
