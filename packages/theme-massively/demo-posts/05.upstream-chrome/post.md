...
template: post
published: true
summary: What this port preserves from HTML5 UP Massively, and what Dune changes.
taxonomy:
  tag: [chrome, massively, fidelity]
---

This demo exercises: hero intro + post cards.
...
Compare side-by-side with [https://html5up.net/massively](https://html5up.net/massively) when QA'ing visual parity.
