...
/**
 * SVG icons copied verbatim from upstream hugo-PaperMod
 * (layouts/_partials/header.html, footer.html, svg.html, share_icons.html).
 * MIT — Copyright (c) 2020 nanxiaobei and adityatelange.
 */
...
export const ExternalIcon = ({ size = 12 }: { size?: number }) => (
  <svg fill="none" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round"
    stroke-linejoin="round" stroke-width="2.5" viewBox="0 0 24 24" height={size} width={size}>
...
export const DraftIcon = ({ height = 35 }: { height?: number }) => (
...
export const RssIcon = ({ height = 23 }: { height?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    stroke-linecap="round" stroke-linejoin="round" height={height}>
...
/* Social/share icons (subset of upstream svg.html — same paths). */

export const GithubIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" height="30" width="30">
    <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
  </svg>
);

export const XIcon = ({ size = 30 }: { size?: number }) => (
  <svg version="1.1" viewBox="0 0 512 512" xml:space="preserve" height={`${size}px`} width={`${size}px`} fill="currentColor">
...
export const RedditIcon = ({ size = 30 }: { size?: number }) => (
  <svg version="1.1" viewBox="0 0 512 512" xml:space="preserve" height={`${size}px`} width={`${size}px`} fill="currentColor">
...
export const WhatsappIcon = ({ size = 30 }: { size?: number }) => (
  <svg version="1.1" viewBox="0 0 512 512" xml:space="preserve" height={`${size}px`} width={`${size}px`} fill="currentColor">
...
export const TelegramIcon = ({ size = 30 }: { size?: number }) => (
  <svg version="1.1" xml:space="preserve" viewBox="2 2 28 28" height={`${size}px`} width={`${size}px`} fill="currentColor">
...
export const YCombinatorIcon = ({ size = 30 }: { size?: number }) => (
  <svg version="1.1" xml:space="preserve" width={`${size}px`} height={`${size}px`} viewBox="0 0 512 512" fill="currentColor">
