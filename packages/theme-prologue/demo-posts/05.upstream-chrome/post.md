...
template: post
published: true
summary: What this port preserves from HTML5 UP Prologue, and what Dune changes.
taxonomy:
  tag: [chrome, prologue, fidelity]
---

This demo exercises: avatar sidebar + scrolly one-page sections.
...
Compare side-by-side with [https://html5up.net/prologue](https://html5up.net/prologue) when QA'ing visual parity.
