...
Icon sidebar landing with portfolio scroll sections. Adapted from
[HTML5 UP Prologue](https://html5up.net/prologue) (CC BY 3.0).

![Prologue screenshot](https://themes.getdune.org/prologue/themes/prologue/static/screenshot.png)

**Demo**: https://themes.getdune.org/prologue

**Tags**: dune-theme, landing, html5up, sidebar, portfolio
...
themes:
  - name: prologue
    src: jsr:@dune/theme-prologue@1.0.0
...
Icon sidebar landing with portfolio scroll sections. See the
[live demo](https://themes.getdune.org/prologue).

## Templates

| Template | Role |
|---|---|
| `default` | Portfolio scroll landing on home; section pages elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Prologue is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/prologue](https://html5up.net/prologue)).
