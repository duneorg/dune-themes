...
metadata:
  description: Fennec typography and markdown surfaces in one place.
---

Reference for headings, lists, code, and tables as Fennec styles them in
plain pages and posts. Card grids live on the home and blog listing —
this page is the body typography.
...
| Option | Type | Default |
| --- | --- | --- |
| `color_scheme` | select | `terracotta` |
...
That horizontal rule is the divider Fennec’s stylesheet defines — a plain
