...
template: post
published: true
summary: What this port preserves from HTML5 UP Read Only, and what Dune changes.
taxonomy:
  tag: [chrome, read-only, fidelity]
---

This demo exercises: resume/profile sidebar + content column.
...
Compare side-by-side with [https://html5up.net/read-only](https://html5up.net/read-only) when QA'ing visual parity.
