 ...
 * surfaces onto `--accent` / `--bg` / `--bg-alt` / `--code-bg` / `--sidebar-bg` (Starlight-inspired chrome).
 */
...
/** Starlight-adjacent violet (scheme id `purple`). */
...
const NEUTRAL_BG = { light: "#ffffff", dark: "#17181c" };
const NEUTRAL_ALT = { light: "#f6f7f9", dark: "#1b1d22" };
const NEUTRAL_CODE = { light: "#f3f4f6", dark: "#24272e" };
const NEUTRAL_SIDEBAR = { light: "#f6f7f9", dark: "#17181c" };
