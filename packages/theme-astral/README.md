...
Icon sidebar with panel pages and a portfolio grid. Adapted from
[HTML5 UP Astral](https://html5up.net/astral) (CC BY 3.0).

![Astral screenshot](https://themes.getdune.org/astral/themes/astral/static/screenshot.png)

**Demo**: https://themes.getdune.org/astral

**Tags**: dune-theme, portfolio, html5up, gallery, panels
...
themes:
  - name: astral
    src: jsr:@dune/theme-astral@1.0.0
...
Icon nav, intro panel, and image grid. See the
[live demo](https://themes.getdune.org/astral).

## Templates

| Template | Role |
|---|---|
| `default` | Intro panel + explore tiles on home; panels elsewhere |
...
- **No dark mode / no color-scheme presets** — upstream Astral is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/astral](https://html5up.net/astral)).
