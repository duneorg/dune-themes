...
template: post
published: true
summary: What this port preserves from HTML5 UP Aerial, and what Dune changes.
taxonomy:
  tag: [chrome, aerial, fidelity]
---

This demo exercises: fullscreen background video/image shell with overlay nav.
...
Compare side-by-side with [https://html5up.net/aerial](https://html5up.net/aerial) when QA'ing visual parity.
