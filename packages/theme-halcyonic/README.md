...
Business landing with banner and feature grid. Adapted from
[HTML5 UP Halcyonic](https://html5up.net/halcyonic) (CC BY 3.0).

![Halcyonic screenshot](https://themes.getdune.org/halcyonic/themes/halcyonic/static/screenshot.png)

**Demo**: https://themes.getdune.org/halcyonic
...
themes:
  - name: halcyonic
    src: jsr:@dune/theme-halcyonic@1.0.0
...
Business landing with banner and feature grid. See the
[live demo](https://themes.getdune.org/halcyonic).

## Templates

| Template | Role |
|---|---|
| `default` | Banner + features on home; content pages elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Halcyonic is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/halcyonic](https://html5up.net/halcyonic)).
