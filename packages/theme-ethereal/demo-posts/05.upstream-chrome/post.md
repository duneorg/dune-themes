...
template: post
published: true
summary: What this port preserves from HTML5 UP Ethereal, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/ethereal](https://html5up.net/ethereal) when QA'ing visual parity.
