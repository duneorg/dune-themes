...
Panel-based landing with banner spotlight. Adapted from
[HTML5 UP Ethereal](https://html5up.net/ethereal) (CC BY 3.0).

![Ethereal screenshot](https://themes.getdune.org/ethereal/themes/ethereal/static/screenshot.png)

**Demo**: https://themes.getdune.org/ethereal

**Tags**: dune-theme, landing, html5up, panels
...
```bash
dune theme:install jsr:@dune/theme-ethereal@1.0.1 --activate
```
...
themes:
  - name: ethereal
    src: jsr:@dune/theme-ethereal@1.0.1
...
Banner panel, spotlights, and icon grid on home. See the
[live demo](https://themes.getdune.org/ethereal).

## Templates

| Template | Role |
|---|---|
| `default` | Panel landing on home; plain pages elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Ethereal is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/ethereal](https://html5up.net/ethereal)).
