 ...
 * sirocco/caravan/ink/gale (stable ids; labels name the hues). Salon maps
...
/** Crimson is Salon's magazine brand accent. */
export const DEFAULT_COLOR_SCHEME = "rose";
...
const NEUTRAL_BG = { light: "#ffffff", dark: "#121212" };
const NEUTRAL_ALT = { light: "#fafafa", dark: "#1c1c1c" };
const NEUTRAL_CODE = { light: "#f5f5f5", dark: "#242424" };
