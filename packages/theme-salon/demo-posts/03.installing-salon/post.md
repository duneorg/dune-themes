---
title: Installing Salon
date: 2026-07-20
template: post
published: true
summary: The two ways to add Salon to a Dune site — JSR or a ZIP.
taxonomy:
  tag: [install, salon]
cover: /themes/salon/static/demo/cover-installing.jpg
---

If you're looking at this demo and want Salon on your own site, there are
two install paths.
...
into `themes/salon/` in your site, then set:
