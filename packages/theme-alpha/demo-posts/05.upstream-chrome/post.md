...
template: post
published: true
summary: What this port preserves from HTML5 UP Alpha, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/alpha](https://html5up.net/alpha) when QA'ing visual parity.
