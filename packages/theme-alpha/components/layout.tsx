...
export default function Layout({
  ...
  return (
    <html lang={page?.language ?? "en"} dir={dir ?? "ltr"}>
      ...
      <body class={isHome ? "landing is-preload" : "is-preload"}>
        <div id="page-wrapper">
          <header id="header" class={isHome ? "alt" : undefined}>
            <h1><a href="/">{site?.title ?? "Alpha"}</a></h1>
            <nav id="nav">
              <ul>
                {navItems.map((item) => (
            ...
            <section id="banner">
              ...
              {blogRoute && (
                <ul class="actions special">
                  <li><a href={blogRoute} class="button primary">Read the Blog</a></li>
                  <li><a href={blogRoute} class="button">Learn More</a></li>
                </ul>
              )}
            </section>
          )}
          ...
          <footer id="footer">
            {showCredit && (
              <ul class="copyright">
                ...
                <li>Design: <a href="https://html5up.net/alpha">HTML5 UP</a></li>
              </ul>
            )}
          </footer>
        </div>
