...
Business landing with hero banner and container content. Adapted from
[HTML5 UP Alpha](https://html5up.net/alpha) (CC BY 3.0).

![Alpha screenshot](https://themes.getdune.org/alpha/themes/alpha/static/screenshot.png)

**Demo**: https://themes.getdune.org/alpha
...
themes:
  - name: alpha
    src: jsr:@dune/theme-alpha@1.0.0
...
[live demo](https://themes.getdune.org/alpha).

## Templates

| Template | Role |
|---|---|
| `default` | Home boxes / plain pages |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Alpha is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/alpha](https://html5up.net/alpha)).
