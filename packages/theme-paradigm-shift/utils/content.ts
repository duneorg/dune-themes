export function formatParadigmShiftDate(raw: string): string {
...
export function galleryImage(themeName: string, file: string): string {
  return `/themes/${themeName}/static/html5up/images/gallery/${file}`;
}
