...
template: post
published: true
summary: What this port preserves from HTML5 UP Paradigm Shift, and what Dune changes.
taxonomy:
  tag: [chrome, paradigm-shift, fidelity]
---

This demo exercises: image/text spotlights in alternating rows.
...
Compare side-by-side with [https://html5up.net/paradigm-shift](https://html5up.net/paradigm-shift) when QA'ing visual parity.
