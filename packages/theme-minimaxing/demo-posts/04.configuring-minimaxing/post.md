...
template: post
published: true
summary: Theme options for the Minimaxing demo — still a single upstream design.
taxonomy:
...
| `banner_title` | see `theme.yaml` |
| `show_html5up_credit` | see `theme.yaml` |
| `footer_text` | see `theme.yaml` |

**No dark mode / no color-scheme presets.** Upstream Minimaxing is one design;
