...
template: post
published: true
summary: What this port preserves from HTML5 UP Minimaxing, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/minimaxing](https://html5up.net/minimaxing) when QA'ing visual parity.
