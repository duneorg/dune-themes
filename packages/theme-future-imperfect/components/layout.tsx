    ...
    <html lang={page?.language ?? "en"} dir={dir ?? "ltr"} class={defaultDark ? "dark" : ""}>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){var s=localStorage.getItem('theme-future-imperfect');
      ...
      <body class="theme-future-imperfect archetype-blog-magazine">
        <header class="site-header">
          <a class="site-logo" href="/">{site?.title ?? "Future Imperfect"}</a>
        ...
        <footer class="site-footer">
          {footerText || (
            <>
              © {new Date().getFullYear()} {site?.title ?? "Future Imperfect"} ·{" "}
              {(themeConfig?.show_html5up_credit !== false) && (
                <>
                  <a href="https://html5up.net/future-imperfect">Future Imperfect by HTML5 UP</a> ·{" "}
                </>
              )}
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            btn.addEventListener('click',function(){
              ...
              localStorage.setItem('theme-future-imperfect',dark?'dark':'light');
            });
          })();
        ` }} />
      </body>
