...
template: post
published: true
summary: What this port preserves from HTML5 UP Future Imperfect, and what Dune changes.
taxonomy:
  tag: [chrome, future-imperfect, fidelity]
---

This demo exercises: card grid with search/menu overlays.
...
Compare side-by-side with [https://html5up.net/future-imperfect](https://html5up.net/future-imperfect) when QA'ing visual parity.
