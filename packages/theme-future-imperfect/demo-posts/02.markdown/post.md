---
title: Future Imperfect's typography
date: 2026-02-01
template: post
published: true
summary: How Future Imperfect sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, future-imperfect]
---

Future Imperfect is the HTML5 UP magazine blog adapted for Dune. This post
dogfoods the markdown surfaces the vendored stylesheet paints.
...
That horizontal rule is the divider Future Imperfect’s stylesheet defines.
