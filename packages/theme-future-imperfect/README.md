...
```bash
dune theme:install jsr:@dune/theme-future-imp@1.0.0 --activate
```
...
themes:
  - name: future-imperfect
    src: jsr:@dune/theme-future-imp@1.0.0
...
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/future-imperfect](https://html5up.net/future-imperfect)).
