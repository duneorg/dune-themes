...
template: post
published: true
summary: What this port preserves from HTML5 UP Directive, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/directive](https://html5up.net/directive) when QA'ing visual parity.
