...
Hero landing with feature bands and centered content. Adapted from
[HTML5 UP Directive](https://html5up.net/directive) (CC BY 3.0).

![Directive screenshot](https://themes.getdune.org/directive/themes/directive/static/screenshot.png)

**Demo**: https://themes.getdune.org/directive

**Tags**: dune-theme, landing, html5up, features
...
themes:
  - name: directive
    src: jsr:@dune/theme-directive@1.0.0
...
Hero landing with feature bands and centered content. See the
[live demo](https://themes.getdune.org/directive).

## Templates

| Template | Role |
|---|---|
| `default` | Hero + feature bands on home; boxed pages elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Directive is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/directive](https://html5up.net/directive)).
