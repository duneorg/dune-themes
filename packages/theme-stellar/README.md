...
Multipurpose landing with logo header, spotlight, and statistics. Adapted from
[HTML5 UP Stellar](https://html5up.net/stellar) (CC BY 3.0).

![Stellar screenshot](https://themes.getdune.org/stellar/themes/stellar/static/screenshot.png)

**Demo**: https://themes.getdune.org/stellar

**Tags**: dune-theme, landing, html5up, multipurpose
...
themes:
  - name: stellar
    src: jsr:@dune/theme-stellar@1.0.0
...
Multipurpose landing with logo header, spotlight, and statistics. See the
[live demo](https://themes.getdune.org/stellar).

## Templates

| Template | Role |
|---|---|
| `default` | Spotlight/features landing on home; main content elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Stellar is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/stellar](https://html5up.net/stellar)).
