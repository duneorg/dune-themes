...
template: post
published: true
summary: What this port preserves from HTML5 UP Stellar, and what Dune changes.
taxonomy:
  tag: [chrome, stellar, fidelity]
---

This demo exercises: scrolly sections with icon features and a footer CTA.
...
Compare side-by-side with [https://html5up.net/stellar](https://html5up.net/stellar) when QA'ing visual parity.
