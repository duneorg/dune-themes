    ...
    return (
      <LayoutComponent {...props} landing>
        <section id="header" class="dark">
          ...
          <footer>
            <a href="#first" class="button scrolly">Explore the demo</a>
          </footer>
        </section>
              ...
              <div class="row">
                <div class="col-4 col-12-narrow">
                  <section>
                    ...
                    <p>Sample posts with markdown, code blocks, and tags at <a href="/blog">/blog</a>.</p>
                  </section>
                </div>
                <div class="col-4 col-12-narrow">
                  <section>
                    ...
                    <p>Query demo pages through Dune&apos;s search template at <a href="/search">/search</a>.</p>
                  </section>
                </div>
                <div class="col-4 col-12-narrow">
                  <section>
                    ...
                    <p>Browse posts by year at <a href="/archives">/archives</a>.</p>
                  </section>
                </div>
                <div class="col-12">
                  <footer>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-8 col-12-narrow">
                  <div class="row">
                    <div class="col-6"><a href="/blog" class="image fit"><img src={img("pic01.jpg")} alt="" /></a></div>
                    <div class="col-6"><a href="/about" class="image fit"><img src={img("pic02.jpg")} alt="" /></a></div>
                    <div class="col-6"><a href="/search" class="image fit"><img src={img("pic03.jpg")} alt="" /></a></div>
                    <div class="col-6"><a href="/archives" class="image fit"><img src={img("pic04.jpg")} alt="" /></a></div>
                    <div class="col-6"><a href="/blog" class="image fit"><img src={img("pic05.jpg")} alt="" /></a></div>
        ...
        <section id="footer">
          <ul class="icons">
            ...
            <li><a href="https://html5up.net/tessellate" class="icon brands fa-html5"><span class="label">HTML5 UP</span></a></li>
          </ul>
          <div class="copyright">
            <ul class="menu">
      ...
      <section class="main">
        ...
        <div class="content dark style1">
          <div class="container">
            ...
            <ul class="actions special">
              <li><a href="/" class="button alt">Back to home</a></li>
            </ul>
          </div>
        </div>
      </section>
