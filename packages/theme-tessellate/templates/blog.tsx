        ...
        <div class="content dark style2">
          <div class="container">
            ...
            {(pagination?.newer || pagination?.older) && (
              <ul class="actions">
                {pagination.older && <li><a href={pagination.older} class="button alt">← {tr("pagination.older", "Older")}</a></li>}
                {pagination.newer && <li><a href={pagination.newer} class="button alt">{tr("pagination.newer", "Newer")} →</a></li>}
              </ul>
            )}
          </div>
        </div>
