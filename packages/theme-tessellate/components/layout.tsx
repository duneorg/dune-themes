  ...
  return (
    <html lang={page?.language ?? "en"} dir={dir ?? "ltr"} class="is-preload">
      ...
      <body class="is-preload">
        <div id="wrapper">
          <header id="header">
            <h1><a href="/">{site?.title ?? "Tessellate"}</a></h1>
            <nav>
          ...
          {showCredit && (
          <ul id="copyright">
            <li>&copy; {new Date().getFullYear()} {site?.title ?? "Tessellate"}.</li>
            <li>Design: <a href="https://html5up.net/tessellate">Tessellate by HTML5 UP</a></li>
          </ul>
        )}
        </div>
