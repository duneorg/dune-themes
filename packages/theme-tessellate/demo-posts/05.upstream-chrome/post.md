...
template: post
published: true
summary: What this port preserves from HTML5 UP Tessellate, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/tessellate](https://html5up.net/tessellate) when QA'ing visual parity.
