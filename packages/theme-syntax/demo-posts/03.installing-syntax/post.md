...
published: true
pinned: true
summary: The two ways to add Syntax to a Dune site — JSR or a ZIP.
taxonomy:
  tag: [install, syntax]
---

If you're looking at this demo and want Syntax on your own site, there are
two install paths.
...
into `themes/syntax/` in your site, then set:
