---
title: Syntax's typography
date: 2026-02-01
template: post
published: true
summary: How Syntax sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, syntax]
---

Syntax is tuned for technical notes that stay scannable. This post
dogfoods the markdown surfaces — especially code and tables.
...
One size down again, for a subsection within a section. Syntax doesn’t
...
weight as the rest of the paragraph — nothing about Syntax's typography
shouts.

---

That horizontal rule is the divider Syntax’s stylesheet defines — a
