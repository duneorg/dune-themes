...
export default function Layout(
  ...
  const themeName = config?.theme?.name ?? "syntax";
  ...
  const title = pageTitle || site?.title || "Syntax";
  ...
  return (
    <html lang={page?.language ?? "en"} dir={dir ?? "ltr"}>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
          (function(){
            var s=localStorage.getItem('theme-syntax');
      ...
      <body class="theme-syntax archetype-blog-tech">
        <header class="site-header syntax-header">
          <div class="syntax-header-inner">
            <a class="site-logo syntax-logo" href={homeHref}>{site?.title ?? "Syntax"}</a>
            <button
              type="button"
              class="nav-toggle"
              aria-expanded="false"
            ...
            <a class="syntax-search-link" href={searchHref}>{tr("search.title", "Search")}</a>
            <div class="syntax-header-controls">
              {showSchemeSwitcher && (
        ...
        {children}
        <footer class="site-footer syntax-footer">
          {footerText || (
            <>
              © {new Date().getFullYear()} {site?.title ?? "Syntax"} · Powered by{" "}
        ...
        <script
          ...
          (function(){
            ...
            var STORAGE_KEY='syntax-color-scheme';
            ...
            if(btn)btn.addEventListener('click',function(){
              ...
              localStorage.setItem('theme-syntax',next);
