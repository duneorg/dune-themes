 ...
 * sirocco/caravan/ink/gale/salon (stable ids; labels name the hues). Syntax maps
...
export const COLOR_SCHEMES: Record<string, ColorScheme> = {
  blue: {
    label: "Cobalt",
    light: { accent: "#0969da", cardBackground: "#d3dae9" },
    dark: { accent: "#58a6ff", cardBackground: "#1b2336" },
  },
  slate: {
    label: "Slate",
...
/** Cobalt (GitHub blue) is Syntax's brand accent. */
...
const NEUTRAL_BG = { light: "#fefefe", dark: "#0d1117" };
const NEUTRAL_ALT = { light: "#f6f8fa", dark: "#161b22" };
const NEUTRAL_CODE = { light: "#f6f8fa", dark: "#1c2128" };
