...
template: post
published: true
summary: What this port preserves from HTML5 UP Twenty, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/twenty](https://html5up.net/twenty) when QA'ing visual parity.
