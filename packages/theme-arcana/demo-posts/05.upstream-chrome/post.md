...
template: post
published: true
summary: What this port preserves from HTML5 UP Arcana, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/arcana](https://html5up.net/arcana) when QA'ing visual parity.
