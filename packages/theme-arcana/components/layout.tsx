...
export default function Layout({
  ...
  const creditHref = safeHref("https://html5up.net/arcana") ?? "https://html5up.net/arcana";
  ...
  return (
    <html lang={page?.language ?? "en"} dir={dir ?? "ltr"}>
      ...
      <body class="is-preload theme-arcana archetype-landing">
        <div id="page-wrapper">
          <div id="header">
            <h1>
              <a href={homeHref} id="logo">{site?.title ?? "Arcana"}</a>
            </h1>
          ...
          {showBanner && (
            <section id="banner">
              <header>
                ...
                {blogRoute && (
                  <a href={blogRoute} class="button">{tr("cta.learn_more", "Learn More")}</a>
                )}
              </header>
            </section>
          )}
