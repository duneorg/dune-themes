...
Corporate landing with logo header and hero banner. Adapted from
[HTML5 UP Arcana](https://html5up.net/arcana) (CC BY 3.0).

![Arcana screenshot](https://themes.getdune.org/arcana/themes/arcana/static/screenshot.png)

**Demo**: https://themes.getdune.org/arcana

**Tags**: dune-theme, landing, html5up, corporate
...
themes:
  - name: arcana
    src: jsr:@dune/theme-arcana@1.0.0
...
[live demo](https://themes.getdune.org/arcana).

## Templates

| Template | Role |
|---|---|
| `default` | Home / plain pages |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Arcana is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/arcana](https://html5up.net/arcana)).
