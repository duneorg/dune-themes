...
Tile-grid blog with a slide-out menu. Adapted from
[HTML5 UP Phantom](https://html5up.net/phantom) (CC BY 3.0).

![Phantom screenshot](https://themes.getdune.org/phantom/themes/phantom/static/screenshot.png)

**Demo**: https://themes.getdune.org/phantom

**Tags**: dune-theme, blog, html5up, tiles
...
themes:
  - name: phantom
    src: jsr:@dune/theme-phantom@1.0.0
...
Tile-grid blog with a slide-out menu. See the [live demo](https://themes.getdune.org/phantom).

## Templates

| `blog` | Tile / card post list |
| `post` | Single post |
| `default` | Plain pages |
...
- **No dark mode / no color-scheme presets** — upstream Phantom is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/phantom](https://html5up.net/phantom)).
