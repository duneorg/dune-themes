...
template: post
published: true
summary: What this port preserves from HTML5 UP Phantom, and what Dune changes.
taxonomy:
  tag: [chrome, phantom, fidelity]
---

This demo exercises: minimal tile/grid portfolio-blog hybrid.
...
Compare side-by-side with [https://html5up.net/phantom](https://html5up.net/phantom) when QA'ing visual parity.
