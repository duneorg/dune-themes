---
title: Elements — Eventually typography
date: 2026-03-18
template: post
published: true
summary: Headings, lists, quotes, and code in Eventually’s post chrome.
taxonomy:
...
Eventually’s landing chrome (coming-soon shell) is louder than post bodies. This Elements leaf lives under `/blog` so CTAs stay real — it checks that inner articles still get a readable type scale.
