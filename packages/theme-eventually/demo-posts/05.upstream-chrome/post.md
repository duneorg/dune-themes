...
template: post
published: true
summary: What this port preserves from HTML5 UP Eventually, and what Dune changes.
taxonomy:
  tag: [chrome, eventually, fidelity]
---

This demo exercises: fullscreen countdown / coming-soon shell with centered copy.
...
Compare side-by-side with [https://html5up.net/eventually](https://html5up.net/eventually) when QA'ing visual parity.
