...
template: post
published: true
summary: Headings, lists, quotes, and code in Story’s post chrome.
taxonomy:
...
Story’s landing chrome (long-scroll narrative) is louder than post bodies. This Elements leaf lives under `/blog` so CTAs stay real — it checks that inner articles still get a readable type scale.
