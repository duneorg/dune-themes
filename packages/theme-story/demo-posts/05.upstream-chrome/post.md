...
template: post
published: true
summary: What this port preserves from HTML5 UP Story, and what Dune changes.
taxonomy:
  tag: [chrome, story, fidelity]
---

This demo exercises: long-scroll narrative sections with spotlights.
...
Compare side-by-side with [https://html5up.net/story](https://html5up.net/story) when QA'ing visual parity.
