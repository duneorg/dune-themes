      ...
      <body class="is-preload">
        <div id="wrapper">
          <div id="main">
            <div class="inner">
              <header id="header">
                <a href="/" class="logo"><strong>{site?.title ?? "Editorial"}</strong></a>
              </header>
              {children}
            </div>
          </div>
          <div id="sidebar">
            <div class="inner">
              ...
              {showCredit && (
          <ul id="copyright">
            <li>&copy; {new Date().getFullYear()} {site?.title ?? "Editorial"}.</li>
            <li>Design: <a href="https://html5up.net/editorial">Editorial by HTML5 UP</a></li>
          </ul>
        )}
            </div>
          </div>
