---
title: Editorial's typography
date: 2026-02-01
template: post
published: true
summary: How Editorial sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, editorial]
---

Editorial is an HTML5 UP blog theme adapted for Dune. This post dogfoods
...
That horizontal rule is the divider Editorial's stylesheet defines.
