---
title: Editorial chrome on Dune
date: 2026-03-15
template: post
published: true
summary: Theme-specific fidelity notes for Editorial — not a generic clone.
taxonomy:
  tag: [chrome, editorial, fidelity]
---

Upstream Editorial is known for **editorial sidebar**. On Dune that chrome is template-driven over vendored `static/html5up/` assets — this post exists so the demo explains what you’re seeing instead of shipping a generic clone.

Editorial sidebar + featured article layout.
