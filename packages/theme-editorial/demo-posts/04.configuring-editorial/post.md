...
template: post
published: true
summary: Theme options for the Editorial demo — still a single upstream design.
taxonomy:
...
| Option | Notes |
|--------|--------|
| `logo_suffix` | see `theme.yaml` |
| `sidebar_blurb` | see `theme.yaml` |
| `show_html5up_credit` | see `theme.yaml` |
| `footer_text` | see `theme.yaml` |

**No dark mode / no color-scheme presets.** Upstream Editorial is one design;
