...
template: post
published: true
summary: What this port preserves from HTML5 UP Dopetrope, and what Dune changes.
taxonomy:
  tag: [chrome, dopetrope, fidelity]
---

This demo exercises: magazine-style feature + post columns.
...
Compare side-by-side with [https://html5up.net/dopetrope](https://html5up.net/dopetrope) when QA'ing visual parity.
