...
template: post
published: true
summary: How Dopetrope sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, dopetrope]
---

Dopetrope is an HTML5 UP blog theme adapted for Dune. This post dogfoods
...
| `banner_title` | text | *(site title)* |
| `banner_subtitle` | text | *(empty)* |
...
That horizontal rule is the divider Dopetrope's stylesheet defines.
