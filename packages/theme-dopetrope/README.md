...
Magazine blog with an optional home hero banner. Adapted from
[HTML5 UP Dopetrope](https://html5up.net/dopetrope) (CC BY 3.0).

![Dopetrope screenshot](https://themes.getdune.org/dopetrope/themes/dopetrope/static/screenshot.png)

**Demo**: https://themes.getdune.org/dopetrope
...
themes:
  - name: dopetrope
    src: jsr:@dune/theme-dopetrope@1.0.0
...
Magazine blog with an optional home hero banner. See the [live demo](https://themes.getdune.org/dopetrope).
...
- **No dark mode / no color-scheme presets** — upstream Dopetrope is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/dopetrope](https://html5up.net/dopetrope)).
