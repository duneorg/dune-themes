---
title: Strongly Typed's typography
date: 2026-02-01
template: post
published: true
summary: How Strongly Typed sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, strongly-typed]
---

Strongly Typed is an HTML5 UP blog theme adapted for Dune. This post dogfoods
...
| `header_tagline` | text | *(site description)* |
| `show_banner` | toggle | `true` |
| `banner_text` | text | *(empty)* |
...
That horizontal rule is the divider Strongly Typed's stylesheet defines.
