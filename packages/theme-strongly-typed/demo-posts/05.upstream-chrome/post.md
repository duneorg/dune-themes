...
template: post
published: true
summary: What this port preserves from HTML5 UP Strongly Typed, and what Dune changes.
taxonomy:
  tag: [chrome, strongly-typed, fidelity]
---

This demo exercises: typed header + boxed content columns.
...
Compare side-by-side with [https://html5up.net/strongly-typed](https://html5up.net/strongly-typed) when QA'ing visual parity.
