      ...
      <LayoutComponent {...props} landing>
        <section id="intro" class="wrapper style1">
          ...
          <div class="container">
            ...
            <p class="style2">
              {page.frontmatter.title ?? "Escape Velocity"} for Dune<br class="mobile-hide" />
              — adapted from <a href="https://html5up.net/escape-velocity" class="nobr">HTML5 UP</a>
            </p>
            {children && (
              <div class="style3" data-dune-body>{children}</div>
            )}
            <ul class="actions">
              <li><a href="/blog" class="button style3 large">Proceed</a></li>
            </ul>
          </div>
        </section>
        ...
        <section id="main" class="wrapper style2">
          ...
          <div class="container">
            <a href="/blog" class="image featured">
            ...
            <section id="features">
                ...
                <div class="row">
                  <div class="col-6 col-12-medium">
                    <section>
                      ...
                      <p>Collection-driven blog listing at <a href="/blog">/blog</a> with dated posts and pagination support.</p>
                    </section>
                  </div>
                  <div class="col-6 col-12-medium">
                    <section>
                      <h3 class="icon solid fa-sync">Responsive shell</h3>
                      <p>Upstream Escape Velocity CSS with homepage and inner-page body classes preserved.</p>
                    </section>
                  </div>
                  <div class="col-6 col-12-medium">
                    <section>
              ...
              <ul class="actions special">
                <li><a href="/blog" class="button style1 large">Get Started</a></li>
                <li><a href="/about" class="button style2 large">About</a></li>
              </ul>
            </section>
          </div>
        </section>
            ...
            <div class="row aln-center">
              <div class="col-4 col-12-medium">
                <section class="highlight">
                  <a href="/blog" class="image featured"><img src={img("pic02.jpg")} alt="" /></a>
                  ...
                  <ul class="actions">
                    <li><a href="/blog" class="button style1">Learn More</a></li>
                  </ul>
                </section>
              </div>
              <div class="col-4 col-12-medium">
                <section class="highlight">
                  <a href="/search" class="image featured"><img src={img("pic03.jpg")} alt="" /></a>
                  <h3><a href="/search">Search</a></h3>
                  <p>Query demo pages through Dune&apos;s search template and API endpoint.</p>
                  <ul class="actions">
                    <li><a href="/search" class="button style1">Learn More</a></li>
                  </ul>
                </section>
              </div>
              <div class="col-4 col-12-medium">
                <section class="highlight">
                  <a href="/archives" class="image featured"><img src={img("pic04.jpg")} alt="" /></a>
                  <h3><a href="/archives">Archives</a></h3>
                  <p>Browse all posts grouped by year in a clean chronological index.</p>
                  <ul class="actions">
                    <li><a href="/archives" class="button style1">Learn More</a></li>
                  </ul>
                </section>
              </div>
            </div>
