 ...
 * sirocco/caravan/ink/gale/salon/syntax (stable ids; labels name the hues). Herald maps
 * surfaces onto `--accent` / `--bg` / `--bg-alt` / `--code-bg`.
 */
...
export const COLOR_SCHEMES: Record<string, ColorScheme> = {
  blue: {
    label: "Cobalt",
    light: { accent: "#3eb0ef", cardBackground: "#d3e8f4" },
    dark: { accent: "#7dd3fc", cardBackground: "#1a2833" },
  },
  slate: {
    label: "Slate",
...
/** Casper sky-blue is Herald's brand accent (stored as scheme id `blue`). */
...
const NEUTRAL_BG = { light: "#ffffff", dark: "#0a0c0d" };
const NEUTRAL_ALT = { light: "#f4f4f4", dark: "#15171a" };
const NEUTRAL_CODE = { light: "#f4f4f4", dark: "#1c2128" };
