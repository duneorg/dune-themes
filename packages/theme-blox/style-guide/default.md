...
metadata:
  description: Blox body typography and markdown surfaces in one place.
---

Reference for headings, lists, code, and tables as this port styles
ordinary markdown. Live **blocks and shortcodes** stay under
[theme docs](/theme-docs/blocks-and-shortcodes/) — this page is the
shared content bar only.
...
| Option | Type | Default |
| --- | --- | --- |
| `color_scheme` | select | *(theme default)* |
...
That horizontal rule is the divider Blox’s stylesheet defines — a plain
