...
import { profileName, profileOf } from "./shared.ts";
...
export function ResumeBiography3(
  { content, design, ctx }: {
          ...
          <div class="md:col-span-4 flex flex-col items-center text-center space-y-6 md:space-y-8">
            ...
            <div class="space-y-3">
              ...
              {affiliations.map((aff) => {
                ...
                const affUrl = typeof aff === "string" ? undefined : safeHref(aff.url);
    ...
    <div class="flex flex-col items-center max-w-prose mx-auto gap-3 justify-center">
      ...
      <div class="w-full flex flex-col gap-6">
        {awards.map((award) => {
          ...
          const certUrl = safeHref(award.certificate_url);
...
export function ResumeLanguages({ content }: { content: Record<string, unknown> }) {
  const profile = profileOf(content);
