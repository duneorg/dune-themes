...
template: post
published: true
summary: What this port preserves from HTML5 UP Spectral, and what Dune changes.
taxonomy:
  tag: [chrome, spectral, fidelity]
---

This demo exercises: banner + spotlight sections and a prominent CTA band.
...
Compare side-by-side with [https://html5up.net/spectral](https://html5up.net/spectral) when QA'ing visual parity.
