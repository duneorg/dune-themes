...
template: post
published: true
summary: What this port preserves from HTML5 UP Strata, and what Dune changes.
taxonomy:
  tag: [chrome, strata, fidelity]
---

This demo exercises: avatar header + thumbnail portfolio grid.
...
Compare side-by-side with [https://html5up.net/strata](https://html5up.net/strata) when QA'ing visual parity.
