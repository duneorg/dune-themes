 ...
 * sirocco/caravan (stable ids; labels name the hues). Ink maps surfaces onto
...
/** Terracotta is Ink's brand accent. */
...
const NEUTRAL_BG = { light: "#faf9f7", dark: "#1a1814" };
const NEUTRAL_ALT = { light: "#f0eeeb", dark: "#252219" };
const NEUTRAL_CODE = { light: "#f0eeeb", dark: "#2a2620" };
