---
title: Ink's typography
date: 2026-02-01
template: post
published: true
summary: How Ink sets headings, lists, blockquotes, code, and links.
taxonomy:
  tag: [typography, ink]
---

Ink leans on quiet serif body type and a small chrome. This post
shows the markdown surfaces the stylesheet actually styles.
...
One size down again, for a subsection within a section. Ink doesn’t
...
weight as the rest of the paragraph — nothing about Ink's typography
shouts.

---

That horizontal rule is the divider Ink’s stylesheet defines — a plain
