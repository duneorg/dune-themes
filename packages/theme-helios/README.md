...
Homepage carousel with a centered header and banner. Adapted from
[HTML5 UP Helios](https://html5up.net/helios) (CC BY 3.0).

![Helios screenshot](https://themes.getdune.org/helios/themes/helios/static/screenshot.png)

**Demo**: https://themes.getdune.org/helios

**Tags**: dune-theme, landing, html5up, carousel, banner
...
themes:
  - name: helios
    src: jsr:@dune/theme-helios@1.0.0
...
Carousel landing with page-wrapper header and no-sidebar inner pages. See the
[live demo](https://themes.getdune.org/helios).

## Templates

| Template | Role |
|---|---|
| `default` | Carousel landing on home; no-sidebar pages elsewhere |
| `blog` | Post listing |
| `post` | Single post |
...
- **No dark mode / no color-scheme presets** — upstream Helios is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/helios](https://html5up.net/helios)).
