...
template: post
published: true
summary: What this port preserves from HTML5 UP Landed, and what Dune changes.
taxonomy:
  tag: [chrome, landed, fidelity]
---

This demo exercises: nav banner + feature drops and CTA bands.
...
Compare side-by-side with [https://html5up.net/landed](https://html5up.net/landed) when QA'ing visual parity.
