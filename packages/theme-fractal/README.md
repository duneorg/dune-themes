...
Phone-mockup hero with spotlight portfolio sections. Adapted from
[HTML5 UP Fractal](https://html5up.net/fractal) (CC BY 3.0).

![Fractal screenshot](https://themes.getdune.org/fractal/themes/fractal/static/screenshot.png)

**Demo**: https://themes.getdune.org/fractal

**Tags**: dune-theme, portfolio, html5up, gallery, phone-mockup
...
themes:
  - name: fractal
    src: jsr:@dune/theme-fractal@1.0.0
...
Phone hero, spotlight rows, and icon CTAs. See the
[live demo](https://themes.getdune.org/fractal).

## Templates

| Template | Role |
|---|---|
| `default` | Landing spotlights on home; plain pages elsewhere |
...
- **No dark mode / no color-scheme presets** — upstream Fractal is a single design; a Dune dark or multi-scheme lift may land later as an optional enhancement, not as fidelity work.
- **CC BY credit** remains visible when `show_html5up_credit` is on (compare [https://html5up.net/fractal](https://html5up.net/fractal)).
