...
template: post
published: true
summary: What this port preserves from HTML5 UP Fractal, and what Dune changes.
taxonomy:
  tag: [chrome, fractal, fidelity]
---

This demo exercises: phone mockup hero plus feature icons.
...
Compare side-by-side with [https://html5up.net/fractal](https://html5up.net/fractal) when QA'ing visual parity.
