---
title: Elements — Fractal typography
date: 2026-03-18
template: post
published: true
summary: Headings, lists, quotes, and code in Fractal’s post chrome.
taxonomy:
...
Fractal’s landing chrome (phone mockup) is louder than post bodies. This Elements leaf lives under `/blog` so CTAs stay real — it checks that inner articles still get a readable type scale.
