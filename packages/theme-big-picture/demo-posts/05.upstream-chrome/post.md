...
template: post
published: true
summary: What this port preserves from HTML5 UP Big Picture, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/big-picture](https://html5up.net/big-picture) when QA'ing visual parity.
