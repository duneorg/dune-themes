...
template: post
published: true
summary: What this port preserves from HTML5 UP Highlights, and what Dune changes.
taxonomy:
...
Compare side-by-side with [https://html5up.net/highlights](https://html5up.net/highlights) when QA'ing visual parity.
